...
play:
	...
	ocamlfind ocamlc -package yojson -package str -package ANSITerminal -linkpkg card.mli player.mli AI.mli save_game.mli game_engine.mli card.ml player.ml AI.ml save_game.ml whoknows.ml game_engine.ml main.ml -o game
	mv *.cmi *.cmxa *.cma *.cmx *.cmo *.o *.so *.a _build
